        ...
        <footer className="footer">
            <div className="grid">
                <div className="container">
                    ...
                    <div>
                        <a href="https://www.linkedin.com/in/hoi-wing-henry-cheung/" target="_blank">
                        ...
                        {/* <a href="https://github.com/henrycheunghw" target="_blank">
                            <svg className="icon github" width="66" height="66" viewBox="0 0 66 66" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_306_45)">
                            <path className="fill" fill-rule="evenodd" clip-rule="evenodd" d="M32.9988 0.822173C14.7771 0.822173 0 15.5968 0 33.8208C0 48.4019 9.45429 60.7672 22.5664 65.1327C24.2168 65.4383 24.8234 64.4152 24.8234 63.5431C24.8234 62.7563 24.7905 60.157 24.7771 57.4018C15.5957 59.3982 13.6602 53.5066 13.6602 53.5066C12.1596 49.6917 9.99632 48.6771 9.99632 48.6771C7.00239 46.6271 10.2241 46.6722 10.2241 46.6722C13.5371 46.9037 15.2814 50.0705 15.2814 50.0705C18.2266 55.1156 23.0037 53.6552 24.8855 52.8135C25.1827 50.6807 26.0354 49.224 26.9805 48.3994C19.6504 47.5675 11.9452 44.7368 11.9452 32.0912C11.9452 28.4895 13.2363 25.5443 15.3447 23.2348C15.0013 22.4018 13.8709 19.0473 15.6626 14.5028C15.6626 14.5028 18.4336 13.6149 24.7406 17.8853C27.3715 17.1557 30.1937 16.7879 32.9964 16.7757C35.8014 16.7879 38.6285 17.1545 41.2631 17.8853C47.5616 13.6174 50.3301 14.5028 50.3301 14.5028C52.1242 19.0486 50.9988 22.4054 50.6553 23.2349C52.771 25.5443 54.0512 28.4895 54.0512 32.0912C54.0512 44.766 46.3289 47.5528 38.9829 48.3701C40.1669 49.3932 41.2241 51.4018 41.2241 54.4785C41.2241 58.8914 41.1864 62.448 41.1864 63.5333C41.1864 64.4115 41.7808 65.4383 43.4543 65.1167C56.559 60.7489 66.0012 48.3822 66.0012 33.8098C66.0012 15.5881 51.2266 0.811035 33.0012 0.811035L32.9989 0.82207L32.9988 0.822173Z" fill="url(#paint0_linear_306_45)"/>
                            </g>
                            <defs>
                            <linearGradient id="paint0_linear_306_45" x1="33.0006" y1="0.811035" x2="33.0006" y2="65.1879" gradientUnits="userSpaceOnUse">
                            <stop stop-color="white"/>
                            <stop offset="1" stop-color="#D0D0D0"/>
                            </linearGradient>
                        ...
                        <a href="mailto:hoiwinghenrycheung@gmail.com" target="_blank">
                        ...
                        <a href="https://drive.google.com/file/d/1y03aq5B7tXwzGWyOwYzBY2reAMJaUb_W/view?usp=sharing" target="_blank">
